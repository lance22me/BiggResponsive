...
{
    public class SessionStateService : ISessionStateService, IRequiresSessionState
    {
        ...
        /// NOTE:  Use this if the method that will reload the Session Field takes no params.
        /// </summary>
        /// <typeparam name="TResult">The type of the result.</typeparam>
        /// <param name="key">The key.</param>
        ...
        /// <returns></returns>
        /// <exception cref="ParameterNullException">key</exception>
